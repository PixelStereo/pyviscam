...
shutter_val = {21:'1/10000', 20:'1/6000', 19:'1/3500', 18:'1/2500', 17:'1/1750', \
			   16:'1/1250', 15:'1/1000', 14:'1/600', 13:'1/425', 12:'1/300', 11:'1/215', \
			   10:'1/150', 9:'1/120', 8:'1/100', 7:'1/75', 6:'1/50', 5:'1/25', \
			   4:'1/12', 3:'1/6', 2:'1/3', 1:'1/2', 0:'1/1'}

iris_val = {17:'F1.6', 16:'F2', 15:'F2.4', 14:'F2.8', 13:'F3.4', 12:'F4', 11:'F4.8', \
		    10:'F5.6', 9:'F6.8', 8:'F8', 7:'F9.6', 6:'F11', 5:'F14', 0:'close'}

expo_compensation_val = {14:10.5, 13:9, 12:7.5, 11:6, 10:4.5, 9:3, 8:1.5, 7:0, \
						 6:-1.5, 5:-3, 4:-4.5, 3:-6, 2:-7.5, 1:-9, 0:-10.5}

gain_val = {0:'-3dB', 1:'0dB', 3:'+2dB', 3:'+4dB', 4:'+6dB', 5:'+8dB', 6:'+10dB', \
			7:'+12dB', 8:'+14dB', 9:'+16dB', 10:'+18dB', 11:'+20dB', 12:'+22dB', \
			13:'+24dB', 14:'+26dB', 15:'+28dB'}

gain_limit_val = {4:'+6dB', 5:'+8dB', 6:'+10dB', 7:'+12dB', 8:'+14dB', 9:'+16dB', \
				  10:'+18dB', 11:'+20dB', 12:'+22dB', 13:'+24dB', 14:'+26dB', 15:'+28dB'}
...
#				socketno = (qq & 0b1111)
			...
			or function == 'IR_receive':
				...
				if debug == 4:
					print('generic value for this function')
				if len(reply) == 4:
					a=int(reply[3],16)
					b=int(reply[2],16)
					c=int(reply[1],16)
